...
The rulebook this project is built by. It applies to every contributor, human
or AI — the same rules the maintainer works from. CONTRIBUTING.md holds the
mechanics (setup, tests, releases); this page holds the judgment.
...
- Write in Simplified Technical English and follow Zinsser's four principles:
  simplicity, brevity, clarity, humanity.
- Use short sentences. Use the active voice. Give each word one meaning. Cut
  the clutter.
